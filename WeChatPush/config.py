...
blacklist = ['blacklist1', 'blacklist2', 'blacklist3', 'blacklist4', 'blacklist5']
# 白名单模式，可以是原群名，不是群备注，可以无限添加
# 名字用英文单引号引起来，名字之间用英文逗号隔开
whitelist = ['whitelist1', 'whitelist2', 'whitelist3', 'whitelist4', 'whitelist5']
...
#加密参数 16位
bark_encode_key = 'xxxxxx'

bark_encode_iv = 'xxxxxx'
